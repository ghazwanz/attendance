...
import { getUserAttendanceStats } from '../../users/[id]/UserStats';

export default function StatusAbsensiUser({ id }: { id: string }) {
    ...
    return (
        <div className="w-full mt-8">
            <div className='flex sm:flex-row items-center flex-col justify-between'>
                <h2 className='text-2xl'>Informasi Absensi Saya</h2>
                <div className="flex justify-end gap-4 mb-6 items-end">
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 sm:grid-cols-3 gap-5">
                <div className="bg-gradient-to-r from-red-500 to-red-700 text-white rounded-xl shadow-lg p-6 flex flex-col items-center">
                    ...
                    <span className="text-lg text-center font-semibold">Jumlah Alpa</span>
                </div>
                <div className="bg-gradient-to-r from-orange-500 to-orange-700 text-white rounded-xl shadow-lg p-6 flex flex-col items-center">
                    ...
                    <span className="text-lg text-center font-semibold">Jumlah Terlambat</span>
                </div>
                <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white rounded-xl shadow-lg p-6 flex flex-col items-center">
                    ...
                    <span className="text-lg text-center font-semibold">Jumlah Izin</span>
                </div>
                <div className="bg-gradient-to-r from-green-500 to-green-700 text-white rounded-xl shadow-lg p-6 flex flex-col items-center">
                    ...
                    <span className="text-lg text-center font-semibold">Jumlah Masuk</span>
                </div>
                <div className="bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-xl shadow-lg p-6 flex flex-col items-center">
                    ...
                    <span className="text-lg text-center font-semibold">Jumlah Absensi</span>
                </div>
            </div>
        </div>
    );
