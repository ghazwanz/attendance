...
export default function ProtectedPage() {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col rounded-xl gap-12 items-center justify-start bg-gradient-to-br from-blue-100 to-blue-200 dark:from-slate-800 dark:to-slate-800/35 px-4 sm:px-6 py-10">
